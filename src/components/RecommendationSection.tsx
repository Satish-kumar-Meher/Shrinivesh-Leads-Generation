...
const CARDS: { key: FundKey; cat: string; tone: string; teaser: React.ReactNode }[] = [
  {
    ...
    teaser: (
      <>
        This fund has a <strong>portfolio PE lower than its own 5-year average</strong> right now —
        buying growth at a discount. The fund manager has navigated 3 market corrections without
        deviating from mandate once.
      </>
    ),
  },
  {
    ...
    teaser: (
      <>
        ...
        <strong>high ROCE businesses with zero net debt</strong> — the kind that compound quietly
        for years without making news.
      </>
    ),
  },
  {
    ...
    teaser: (
      <>
        ...
        <strong>portfolio turnover ratio under 20%</strong> — the manager buys and holds conviction
        bets. That discipline is exactly how small cap wealth gets built, not traded.
      </>
    ),
  },
];
      ...
      <div className="reco-grid">
        <div className="reco-left reveal-on-scroll visible">
          ...
          <h2 className="section-title">
            My current picks for the <em>next 5-year cycle.</em>
          </h2>
          <p className="reco-body">
            The model portfolio above wasn't luck. It was a process. I've run the same process to
            identify 3 funds for 2025–2030. The economy is entering a different phase — the right
            funds for the next cycle are not the same as the last one.
          </p>
          <p className="reco-body">
            The fund names are free to access. I only ask that you share your details so I can
            follow up with genuinely personalised advice.
          </p>

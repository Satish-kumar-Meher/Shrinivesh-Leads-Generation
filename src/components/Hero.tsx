    ...
    <section className="hero">
      ...
      <div className="hero-left">
        ...
        <p className="hero-sub">
          Not star ratings. Not bank recommendations. Fundamentals — PE ratios, fund manager
          stability, and portfolio concentration. This is what disciplined research builds.
        </p>
        <div className="hero-actions">
          <button className="btn-primary" onClick={() => openModal("flexi")}>
            See Our 2025–30 Fund Picks
          </button>
        ...
        <div className="hero-stats">
          <div className="stat-item">
            <span className="stat-num">
              <span className="pv green">₹11.4L</span>
            </span>
            <span className="stat-label">From ₹6L Invested</span>
          </div>
          <div className="stat-item">
            <span className="stat-num">
              <span className="pv green">19.8%</span>
            </span>
        ...
        <p className="hero-disc">
          * Illustrative model portfolio. Not actual client data. Past performance is not indicative
          of future returns.
        </p>
      </div>
          ...
          <div className="card-main">
            ...
            <div className="card-bottom">
              ...
              <div className="vs-badge">
                📊 &nbsp;Alpha generated: +5.6% per annum above benchmark
              </div>
            </div>
          </div>

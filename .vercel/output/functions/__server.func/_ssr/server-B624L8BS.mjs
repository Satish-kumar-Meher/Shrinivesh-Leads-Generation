...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-pGiJnEZb.mjs");
...
const manifest = {
  "2346c51317ba750c0f51204e37e36732bec350fb086a2756d91ce75e1e92b34b": {
    ...
    importer: () => import("./leads-DLfEiuJd.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Bk79mrfr.mjs").then((n2) => n2.r),
    import("./start-Dh67-o6C.mjs"),
